...
export function Header() {
    ...
    return (
        <header className="supports-backdrop-blur:bg-background/60 sticky top-0 z-50 w-full border-b bg-background/90 backdrop-blur bg-white">
            <div className="container px-4 py-4 md:px-8 flex  items-center">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    ...
                                    <Avatar className='h-8 w-8  bg-black text-black'>
